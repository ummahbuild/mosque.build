...
export default function Page(){return <><SiteHeader/><main className="projectWorkspacePage"><LocalProjectWorkspace/><div className="section"><ProjectDataManager/><ProjectControlCenter/><ProjectRecordRegister/><ProjectProcessBoard/></div></main><SiteFooter/></>}

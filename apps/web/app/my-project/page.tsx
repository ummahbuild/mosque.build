...
export default function Page(){return <><SiteHeader/><main className="projectWorkspacePage"><LocalProjectWorkspace/><div className="section"><ProjectIntegrationHub/><ProjectDataManager/><ProjectControlCenter/><ProjectPlanningWorkspace/><ProjectSchedulePlanner/><ProjectRecordRegister/><ProjectProcessBoard/></div></main><SiteFooter/></>}

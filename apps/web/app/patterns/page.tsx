...
import {MosqueArchitectureAtlas} from "@/components/mosque-architecture-atlas";
...
import {IslamicGeometryStudio} from "@/components/islamic-geometry-studio";
...
export default function PatternsPage(){return <><SiteHeader/><main><section className="patternHero"><div className="eyebrow gold">ARCHITECTURE + PATTERN STUDIES</div><h1>Build from lineage, place and purpose.</h1><p>Study spatial traditions before selecting surface geometry. Compare how structure, climate, craft and worship shaped different mosque lineages, then turn the findings into accountable project decisions.</p><div className="heroActions"><a className="button" href="#architecture">Compare lineages ↓</a><a className="secondaryButton lightButton" href="#geometry-studio-title">Construct geometry</a></div></section><section className="section" id="architecture"><MosqueArchitectureAtlas/><ArchitectureLineageExplorer/><ArchitectureComparison/><IslamicArchitectureFramework/></section><section className="section patternLibrarySection" id="library"><header className="sectionHeading"><span className="eyebrow">PATTERN APPLICATIONS</span><h2>Move from precedent to a buildable study.</h2><p>Every diagram is an original abstraction paired with a documented context, suitable applications and questions for specialists.</p></header><PatternGallery/><IslamicGeometryStudio/><PatternModelStudio/></section><section className="section" id="materials"><MaterialAssemblyLibrary/></section></main><SiteFooter/></>}

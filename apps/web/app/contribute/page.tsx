...
export default function ContributePage(){return <><SiteHeader/><main className="contributePage">
  <section className="contributeHero">
    <div><div className="eyebrow gold">OPEN SOURCE · MIT LICENSE</div><h1>Help communities build mosques with greater clarity.</h1><p>mosque.build brings community need, site evidence, design, approvals, cost, sourcing, construction, and long-term care into one connected journey. Contribute code, design, research, documentation, translation, or professional review.</p><div className="heroActions"><a className="button" href={`${github}/blob/main/CONTRIBUTING.md`} target="_blank" rel="noopener noreferrer">Read contributing guidelines ↗</a><a className="secondaryButton lightButton" href={`${github}/issues`} target="_blank" rel="noopener noreferrer">Browse GitHub issues ↗</a><a className="secondaryButton lightButton" href="https://ummah.build" target="_blank" rel="noopener noreferrer">Join ummah.build ↗</a></div><div className="contributeSignals"><span>MIT licensed</span><span>Privacy first</span><span>Evidence aware</span><span>Community centred</span></div></div>
    <aside><span>START HERE</span><h2>A good first contribution is small, verifiable, and useful.</h2><p>Read the contribution rules first. Then fix one accessible interaction, clarify one guide, test one workflow, review one source record, or document one professional boundary.</p><a href={`${github}/blob/main/CONTRIBUTING.md`} target="_blank" rel="noopener noreferrer">Open the contributor guide →</a><a href={`${github}/issues/new/choose`} target="_blank" rel="noopener noreferrer">Choose an issue form →</a></aside>
  </section>

  <nav className="contributeJump" aria-label="Contributing page sections"><a href="#github-guides">GitHub guides</a><a href="#ways-to-help">Ways to help</a><a href="#contribution-path">Contribution path</a><a href="#standards">Project standards</a><a href="#verification">Verification</a><a href="#join">Join the community</a></nav>

  <section className="section githubStart" id="github-guides"><div><div className="eyebrow dark">GITHUB STARTING POINTS</div><h2>Read the rules, then choose the right path.</h2><p className="sectionLead">There are no published project roles right now, so the empty roles section is hidden. Contributions still begin through a focused GitHub issue or pull request.</p></div><div className="githubLinkGrid"><a href={`${github}/blob/main/CONTRIBUTING.md`} target="_blank" rel="noopener noreferrer"><b>Contributing guidelines</b><span>Setup, standards, sources, tests and pull-request expectations.</span></a><a href={`${github}/issues/new/choose`} target="_blank" rel="noopener noreferrer"><b>Choose an issue form</b><span>Report a bug or propose a feature, documentation change, or source record.</span></a><a href={`${github}/blob/main/.github/PULL_REQUEST_TEMPLATE.md`} target="_blank" rel="noopener noreferrer"><b>Pull-request checklist</b><span>Understand the evidence and verification expected before opening a change.</span></a><a href={`${github}/blob/main/CODE_OF_CONDUCT.md`} target="_blank" rel="noopener noreferrer"><b>Code of conduct</b><span>Read the participation standards for this community.</span></a><a href={`${github}/blob/main/SECURITY.md`} target="_blank" rel="noopener noreferrer"><b>Security policy</b><span>Report vulnerabilities privately instead of creating a public issue.</span></a><a href={`${github}/blob/main/docs/NEXT_BUILD.md`} target="_blank" rel="noopener noreferrer"><b>Development roadmap</b><span>See current implementation priorities, dependencies and review gates.</span></a></div></section>

  <section className="section contributeIntro" id="ways-to-help"><div><div className="eyebrow dark">CONTRIBUTION AREAS</div><h2>There is more than one way to contribute.</h2><p className="sectionLead">These are contribution areas, not advertised roles or open positions. You do not need to be an architect or developer to improve careful questions, usable interfaces, trustworthy sources, robust tests, and professional boundaries.</p></div><div className="contributeRoleGrid">{contributionAreas.map(([title,body])=><article key={title}><h3>{title}</h3><p>{body}</p></article>)}</div></section>

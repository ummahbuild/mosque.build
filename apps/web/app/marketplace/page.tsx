...
export default function Page(){const area=areas.find(item=>item.slug==="marketplace")!;return <ProductAreaPage area={area} insert={<><ProcurementWorkspace/><MarketplaceCandidateCatalog/></>}/>}

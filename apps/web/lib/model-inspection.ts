...
export const modelLayers=["spaces","site","walls","openings","guides"] as const;
...
export const defaultInspectionPreferences:InspectionPreferences={view:"iso",layers:{spaces:true,site:true,walls:true,openings:true,guides:true},grid:true,shadows:true,wireframe:false,explode:0};

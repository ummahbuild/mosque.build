...
export function ProductAreaPage({area,insert}:{area:Area;insert?:ReactNode}){
  return <><SiteHeader/><main>
    ...
    {insert?<section className="section workspaceSection" id="workspace"><div className="workspaceSectionIntro"><div className="eyebrow dark">WORKING TOOLS</div><h2>Continue the work saved on this device.</h2><p>Changes persist locally and can be included in a whole-project export. Review boundaries remain attached to each tool.</p></div>{insert}</section>:null}

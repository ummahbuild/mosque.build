...
export function ProductAreaPage({area,insert}:{area:Area;insert?:ReactNode}){
  ...
  return <><SiteHeader/><main>
    ...
    {insert?<nav className="workspaceNav" aria-label={`${area.eyebrow.toLowerCase()} page sections`}><a href="#workspace">Work here</a><a href="#capabilities">Coverage</a><a href="#project-brief">Project foundation</a></nav>:null}

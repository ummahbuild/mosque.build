...
const groups:{label:string;items:ContentsItem[]}[]=[
  {label:"Start here",items:[
    ...
    {id:"project-handoff-readiness",number:"04",label:"Handoff readiness",description:"Recipient packets and review gaps",keys:["mosque-build.project-handoff.v1"]},
    {id:"project-review-gates",number:"05",label:"Review gate control",description:"Evidence, reviewers and recorded outcomes",keys:["mosque-build.review-gates.v1"]},
  ]},
  {label:"Plan and coordinate",items:[
    {id:"project-controls",number:"06",label:"Project controls",description:"Options, permits, budget and progress",keys:["mosque-build.control-center.v1"]},
    {id:"project-planning",number:"07",label:"Planning workspace",description:"Roadmap, lookahead and responsibilities",keys:["mosque-build.project-planning.v1"]},
    {id:"project-schedule",number:"08",label:"Integrated schedule",description:"Dates, dependencies and evidence",keys:["mosque-build.project-schedule.v1"]},
  ]},
  {label:"Evidence and handoff",items:[
    {id:"project-shura",number:"09",label:"Community decisions",description:"Alternatives, voices and review history",keys:["mosque-build.shura-workspace.v1"]},
    {id:"project-records",number:"10",label:"Decision and evidence register",description:"Owned records and review state",keys:["mosque-build.project-records.v1"]},
    {id:"project-lifecycle",number:"11",label:"Lifecycle checklist",description:"Preparation prompts by stage",keys:["mosque-build.process-progress.v1"]},
    {id:"project-data",number:"12",label:"Backup and handoff",description:"Export or restore local work",keys:allKeys},
  ]},
];

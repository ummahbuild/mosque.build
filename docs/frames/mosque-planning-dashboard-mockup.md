# Mosque Planning Dashboard Mockup

![Source frame](../../assets/mockups/mosque_planning_dashboard_mockup.png)

## Frame identity
- **Frame ID:** `frame_mosque-planning-dashboard-mockup`
- **Family:** `design-studio`
- **Source image:** `mosque_planning_dashboard_mockup.png`
- **Dimensions:** 1448 × 1086
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/mosque-planning-dashboard-mockup`

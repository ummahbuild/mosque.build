# Mosque Construction Progress Dashboard

![Source frame](../../assets/mockups/mosque_construction_progress_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-construction-progress-dashboard`
- **Family:** `construction`
- **Source image:** `mosque_construction_progress_dashboard.png`
- **Dimensions:** 1448 × 1086
- **Canonical product area:** `/projects/[projectId]/construction`
- **Prototype route:** `/prototypes/mosque-construction-progress-dashboard`

# Mosque.build Waqf Library Dashboard Mockup

![Source frame](../../assets/mockups/mosque.build_waqf_library_dashboard_mockup.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-waqf-library-dashboard-mockup`
- **Family:** `funding-waqf`
- **Source image:** `mosque.build_waqf_library_dashboard_mockup.png`
- **Dimensions:** 1448 × 1086
- **Canonical product area:** `/projects/[projectId]/funding`
- **Prototype route:** `/prototypes/mosquebuild-waqf-library-dashboard-mockup`

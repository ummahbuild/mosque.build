# Mosque.build Funding Transparency Dashboard

![Source frame](../../assets/mockups/mosque.build_funding_transparency_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-funding-transparency-dashboard`
- **Family:** `funding-waqf`
- **Source image:** `mosque.build_funding_transparency_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/funding`
- **Prototype route:** `/prototypes/mosquebuild-funding-transparency-dashboard`
- **Status:** `visual_reference`

## Purpose
This frame is a visual rendition of the **funding-waqf** product family. It must be implemented from canonical domain data and shared components; values/text embedded in the generated image are illustrative unless independently source-backed.

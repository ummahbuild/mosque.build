# Detailed Mockup Dashboard Ui Screenshot Produc

![Source frame](../../assets/mockups/a_detailed_mockup_dashboard_ui_screenshot_produc.png)

## Frame identity
- **Frame ID:** `frame_a-detailed-mockup-dashboard-ui-screenshot-produc`
- **Family:** `uncategorized`
- **Source image:** `a_detailed_mockup_dashboard_ui_screenshot_produc.png`
- **Dimensions:** 1536 × 1024
- **Canonical product area:** `/prototypes`
- **Prototype route:** `/prototypes/a-detailed-mockup-dashboard-ui-screenshot-produc`

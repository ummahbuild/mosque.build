# Mosque Permit Checklist Dashboard Mockup

![Source frame](../../assets/mockups/mosque_permit_checklist_dashboard_mockup.png)

## Frame identity
- **Frame ID:** `frame_mosque-permit-checklist-dashboard-mockup`
- **Family:** `permits-compliance`
- **Source image:** `mosque_permit_checklist_dashboard_mockup.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/permits`
- **Prototype route:** `/prototypes/mosque-permit-checklist-dashboard-mockup`

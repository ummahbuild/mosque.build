# Ui Brand Presentation Board Dashboard Mocku

![Source frame](../../assets/mockups/wide_ui_brand_presentation_board_dashboard_mocku.png)

## Frame identity
- **Frame ID:** `frame_wide-ui-brand-presentation-board-dashboard-mocku`
- **Family:** `marketing-brand`
- **Source image:** `wide_ui_brand_presentation_board_dashboard_mocku.png`
- **Dimensions:** 1536 × 1024
- **Canonical product area:** `/`
- **Prototype route:** `/prototypes/wide-ui-brand-presentation-board-dashboard-mocku`

# Mosque Design Optimization Dashboard

![Source frame](../../assets/mockups/mosque_design_optimization_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-design-optimization-dashboard`
- **Family:** `design-studio`
- **Source image:** `mosque_design_optimization_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/mosque-design-optimization-dashboard`

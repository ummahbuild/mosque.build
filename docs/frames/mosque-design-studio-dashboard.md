# Mosque Design Studio Dashboard

![Source frame](../../assets/mockups/mosque_design_studio_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-design-studio-dashboard`
- **Family:** `design-studio`
- **Source image:** `mosque_design_studio_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/mosque-design-studio-dashboard`
...
## Related renditions
- `frame_mosque-design-studio-dashboard-mockup`

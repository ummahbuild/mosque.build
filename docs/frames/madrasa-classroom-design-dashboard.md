# Madrasa Classroom Design Dashboard

![Source frame](../../assets/mockups/madrasa_classroom_design_dashboard.png)

## Frame identity
- **Frame ID:** `frame_madrasa-classroom-design-dashboard`
- **Family:** `design-studio`
- **Source image:** `madrasa_classroom_design_dashboard.png`
- **Dimensions:** 1586 × 992
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/madrasa-classroom-design-dashboard`

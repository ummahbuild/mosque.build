# Parking Garage Design Studio Dashboard

![Source frame](../../assets/mockups/parking_garage_design_studio_dashboard.png)

## Frame identity
- **Frame ID:** `frame_parking-garage-design-studio-dashboard`
- **Family:** `parking-mobility`
- **Source image:** `parking_garage_design_studio_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design/site/parking`
- **Prototype route:** `/prototypes/parking-garage-design-studio-dashboard`
- **Status:** `visual_reference`

## Purpose
This frame is a visual rendition of the **parking-mobility** product family. It must be implemented from canonical domain data and shared components; values/text embedded in the generated image are illustrative unless independently source-backed.

# Mosque.build Design Studio Moodboard Dashboard

![Source frame](../../assets/mockups/mosque.build_design_studio_moodboard_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-design-studio-moodboard-dashboard`
- **Family:** `design-studio`
- **Source image:** `mosque.build_design_studio_moodboard_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/mosquebuild-design-studio-moodboard-dashboard`

# Mosque Sustainability Dashboard Showcase

![Source frame](../../assets/mockups/mosque_sustainability_dashboard_showcase.png)

## Frame identity
- **Frame ID:** `frame_mosque-sustainability-dashboard-showcase`
- **Family:** `site-landscape`
- **Source image:** `mosque_sustainability_dashboard_showcase.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design/site`
- **Prototype route:** `/prototypes/mosque-sustainability-dashboard-showcase`

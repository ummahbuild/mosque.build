# Mosque.build Cost Scenarios Dashboard

![Source frame](../../assets/mockups/mosque_build_cost_scenarios_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-cost-scenarios-dashboard`
- **Family:** `uncategorized`
- **Source image:** `mosque_build_cost_scenarios_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/prototypes`
- **Prototype route:** `/prototypes/mosquebuild-cost-scenarios-dashboard`

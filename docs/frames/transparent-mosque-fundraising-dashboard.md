# Mosque Fundraising Dashboard

![Source frame](../../assets/mockups/transparent_mosque_fundraising_dashboard.png)

## Frame identity
- **Frame ID:** `frame_transparent-mosque-fundraising-dashboard`
- **Family:** `funding-waqf`
- **Source image:** `transparent_mosque_fundraising_dashboard.png`
- **Dimensions:** 1448 × 1086
- **Canonical product area:** `/projects/[projectId]/funding`
- **Prototype route:** `/prototypes/transparent-mosque-fundraising-dashboard`

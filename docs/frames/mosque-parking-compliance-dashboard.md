# Mosque Parking Compliance Dashboard

![Source frame](../../assets/mockups/mosque_parking_compliance_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-parking-compliance-dashboard`
- **Family:** `permits-compliance`
- **Source image:** `mosque_parking_compliance_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/permits`
- **Prototype route:** `/prototypes/mosque-parking-compliance-dashboard`
...
## Related renditions
- `frame_parking-compliance-dashboard-mockup`

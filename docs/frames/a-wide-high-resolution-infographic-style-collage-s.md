# Wide High Resolution Infographic Style Collage S

![Source frame](../../assets/mockups/a_wide_high_resolution_infographic_style_collage_s.png)

## Frame identity
- **Frame ID:** `frame_a-wide-high-resolution-infographic-style-collage-s`
- **Family:** `uncategorized`
- **Source image:** `a_wide_high_resolution_infographic_style_collage_s.png`
- **Dimensions:** 1536 × 1024
- **Canonical product area:** `/prototypes`
- **Prototype route:** `/prototypes/a-wide-high-resolution-infographic-style-collage-s`
- **Status:** `visual_reference`

## Purpose
This frame is a visual rendition of the **uncategorized** product family. It must be implemented from canonical domain data and shared components; values/text embedded in the generated image are illustrative unless independently source-backed.

# Wide Flat Ui Design Mockup Dashboard Screensh

![Source frame](../../assets/mockups/a_wide_flat_ui_design_mockup_dashboard_screensh.png)

## Frame identity
- **Frame ID:** `frame_a-wide-flat-ui-design-mockup-dashboard-screensh`
- **Family:** `design-studio`
- **Source image:** `a_wide_flat_ui_design_mockup_dashboard_screensh.png`
- **Dimensions:** 1536 × 1024
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/a-wide-flat-ui-design-mockup-dashboard-screensh`

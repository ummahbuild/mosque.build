# Large Clean Marketing App Showcase Poster Mock

![Source frame](../../assets/mockups/a_large_clean_marketing_app_showcase_poster_mock.png)

## Frame identity
- **Frame ID:** `frame_a-large-clean-marketing-app-showcase-poster-mock`
- **Family:** `marketing-brand`
- **Source image:** `a_large_clean_marketing_app_showcase_poster_mock.png`
- **Dimensions:** 1536 × 1024
- **Canonical product area:** `/`
- **Prototype route:** `/prototypes/a-large-clean-marketing-app-showcase-poster-mock`

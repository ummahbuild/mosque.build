# Mosque Interior Design Studio Mockup

![Source frame](../../assets/mockups/mosque_interior_design_studio_mockup.png)

## Frame identity
- **Frame ID:** `frame_mosque-interior-design-studio-mockup`
- **Family:** `interior-prayer`
- **Source image:** `mosque_interior_design_studio_mockup.png`
- **Dimensions:** 1448 × 1086
- **Canonical product area:** `/projects/[projectId]/design/interior`
- **Prototype route:** `/prototypes/mosque-interior-design-studio-mockup`
...
- `frame_mosque-interior-design-studio-dashboard`

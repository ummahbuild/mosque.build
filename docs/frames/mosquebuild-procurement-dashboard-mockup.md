# Mosque.build Procurement Dashboard Mockup

![Source frame](../../assets/mockups/mosque.build_procurement_dashboard_mockup.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-procurement-dashboard-mockup`
- **Family:** `marketplace-procurement`
- **Source image:** `mosque.build_procurement_dashboard_mockup.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/procurement`
- **Prototype route:** `/prototypes/mosquebuild-procurement-dashboard-mockup`
- **Status:** `visual_reference`

## Purpose
This frame is a visual rendition of the **marketplace-procurement** product family. It must be implemented from canonical domain data and shared components; values/text embedded in the generated image are illustrative unless independently source-backed.

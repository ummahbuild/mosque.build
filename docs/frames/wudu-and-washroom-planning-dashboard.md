# Wudu and Washroom Planning Dashboard

![Source frame](../../assets/mockups/wudu_and_washroom_planning_dashboard.png)

## Frame identity
- **Frame ID:** `frame_wudu-and-washroom-planning-dashboard`
- **Family:** `wudu`
- **Source image:** `wudu_and_washroom_planning_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design/wudu`
- **Prototype route:** `/prototypes/wudu-and-washroom-planning-dashboard`
- **Status:** `visual_reference`

## Purpose
This frame is a visual rendition of the **wudu** product family. It must be implemented from canonical domain data and shared components; values/text embedded in the generated image are illustrative unless independently source-backed.

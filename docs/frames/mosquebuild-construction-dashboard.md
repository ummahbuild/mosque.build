# Mosque.build Construction Dashboard

![Source frame](../../assets/mockups/mosque_build_construction_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-construction-dashboard`
- **Family:** `construction`
- **Source image:** `mosque_build_construction_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/construction`
- **Prototype route:** `/prototypes/mosquebuild-construction-dashboard`

# Mosque Interior Design Dashboard

![Source frame](../../assets/mockups/mosque_interior_design_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-interior-design-dashboard`
- **Family:** `interior-prayer`
- **Source image:** `mosque_interior_design_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design/interior`
- **Prototype route:** `/prototypes/mosque-interior-design-dashboard`

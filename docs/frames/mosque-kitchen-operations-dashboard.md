# Mosque Kitchen Operations Dashboard

![Source frame](../../assets/mockups/mosque_kitchen_operations_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-kitchen-operations-dashboard`
- **Family:** `design-studio`
- **Source image:** `mosque_kitchen_operations_dashboard.png`
- **Dimensions:** 1586 × 992
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/mosque-kitchen-operations-dashboard`

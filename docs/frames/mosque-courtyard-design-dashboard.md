# Mosque Courtyard Design Dashboard

![Source frame](../../assets/mockups/mosque_courtyard_design_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-courtyard-design-dashboard`
- **Family:** `site-landscape`
- **Source image:** `mosque_courtyard_design_dashboard.png`
- **Dimensions:** 1586 × 992
- **Canonical product area:** `/projects/[projectId]/design/site`
- **Prototype route:** `/prototypes/mosque-courtyard-design-dashboard`
...
## Related renditions
- `frame_mosquebuild-courtyard-design-dashboard`

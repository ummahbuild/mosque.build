# Mosque.build Musalla Conversion Dashboard

![Source frame](../../assets/mockups/mosquebuild_musalla_conversion_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-musalla-conversion-dashboard`
- **Family:** `uncategorized`
- **Source image:** `mosquebuild_musalla_conversion_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/prototypes`
- **Prototype route:** `/prototypes/mosquebuild-musalla-conversion-dashboard`

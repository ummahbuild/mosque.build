# Mosque Materials Design Dashboard

![Source frame](../../assets/mockups/mosque_materials_design_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-materials-design-dashboard`
- **Family:** `design-studio`
- **Source image:** `mosque_materials_design_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/mosque-materials-design-dashboard`

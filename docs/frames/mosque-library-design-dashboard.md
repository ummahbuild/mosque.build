# Mosque Library Design Dashboard

![Source frame](../../assets/mockups/mosque_library_design_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-library-design-dashboard`
- **Family:** `design-studio`
- **Source image:** `mosque_library_design_dashboard.png`
- **Dimensions:** 1586 × 992
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/mosque-library-design-dashboard`

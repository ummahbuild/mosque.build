# Mosque Safety and Lighting Dashboard

![Source frame](../../assets/mockups/mosque_safety_and_lighting_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-safety-and-lighting-dashboard`
- **Family:** `site-landscape`
- **Source image:** `mosque_safety_and_lighting_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design/site`
- **Prototype route:** `/prototypes/mosque-safety-and-lighting-dashboard`

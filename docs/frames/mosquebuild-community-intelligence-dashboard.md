# Mosque.build Community Intelligence Dashboard

![Source frame](../../assets/mockups/mosque.build_community_intelligence_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-community-intelligence-dashboard`
- **Family:** `community`
- **Source image:** `mosque.build_community_intelligence_dashboard.png`
- **Dimensions:** 1448 × 1086
- **Canonical product area:** `/projects/[projectId]/community`
- **Prototype route:** `/prototypes/mosquebuild-community-intelligence-dashboard`

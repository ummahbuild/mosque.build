# Mosque.build Funding Dashboard Mockup

![Source frame](../../assets/mockups/mosque.build_funding_dashboard_mockup.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-funding-dashboard-mockup`
- **Family:** `funding-waqf`
- **Source image:** `mosque.build_funding_dashboard_mockup.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/funding`
- **Prototype route:** `/prototypes/mosquebuild-funding-dashboard-mockup`

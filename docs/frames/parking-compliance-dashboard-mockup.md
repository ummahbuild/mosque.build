# Parking Compliance Dashboard Mockup

![Source frame](../../assets/mockups/parking_compliance_dashboard_mockup.png)

## Frame identity
- **Frame ID:** `frame_parking-compliance-dashboard-mockup`
- **Family:** `permits-compliance`
- **Source image:** `parking_compliance_dashboard_mockup.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/permits`
- **Prototype route:** `/prototypes/parking-compliance-dashboard-mockup`
...
## Related renditions
- `frame_mosque-parking-compliance-dashboard`

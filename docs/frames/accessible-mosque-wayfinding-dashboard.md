# Accessible Mosque Wayfinding Dashboard

![Source frame](../../assets/mockups/accessible_mosque_wayfinding_dashboard.png)

## Frame identity
- **Frame ID:** `frame_accessible-mosque-wayfinding-dashboard`
- **Family:** `uncategorized`
- **Source image:** `accessible_mosque_wayfinding_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/prototypes`
- **Prototype route:** `/prototypes/accessible-mosque-wayfinding-dashboard`

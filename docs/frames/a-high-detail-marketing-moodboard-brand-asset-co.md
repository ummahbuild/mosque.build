# High Detail Marketing Moodboard Brand Asset Co

![Source frame](../../assets/mockups/a_high_detail_marketing_moodboard_brand_asset_co.png)

## Frame identity
- **Frame ID:** `frame_a-high-detail-marketing-moodboard-brand-asset-co`
- **Family:** `marketing-brand`
- **Source image:** `a_high_detail_marketing_moodboard_brand_asset_co.png`
- **Dimensions:** 1536 × 1024
- **Canonical product area:** `/`
- **Prototype route:** `/prototypes/a-high-detail-marketing-moodboard-brand-asset-co`

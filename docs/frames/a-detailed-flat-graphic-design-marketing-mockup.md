# Detailed Flat Graphic Design Marketing Mockup

![Source frame](../../assets/mockups/a_detailed_flat_graphic_design_marketing_mockup.png)

## Frame identity
- **Frame ID:** `frame_a-detailed-flat-graphic-design-marketing-mockup`
- **Family:** `marketing-brand`
- **Source image:** `a_detailed_flat_graphic_design_marketing_mockup.png`
- **Dimensions:** 1536 × 1024
- **Canonical product area:** `/`
- **Prototype route:** `/prototypes/a-detailed-flat-graphic-design-marketing-mockup`

# Qibla Wall Design Studio Dashboard

![Source frame](../../assets/mockups/qibla_wall_design_studio_dashboard.png)

## Frame identity
- **Frame ID:** `frame_qibla-wall-design-studio-dashboard`
- **Family:** `interior-prayer`
- **Source image:** `qibla_wall_design_studio_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design/interior`
- **Prototype route:** `/prototypes/qibla-wall-design-studio-dashboard`

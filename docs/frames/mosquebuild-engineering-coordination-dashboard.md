# Mosque.build Engineering Coordination Dashboard

![Source frame](../../assets/mockups/mosque.build_engineering_coordination_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-engineering-coordination-dashboard`
- **Family:** `uncategorized`
- **Source image:** `mosque.build_engineering_coordination_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/prototypes`
- **Prototype route:** `/prototypes/mosquebuild-engineering-coordination-dashboard`

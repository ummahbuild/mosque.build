# Mosque Interior Design Studio Dashboard

![Source frame](../../assets/mockups/mosque_interior_design_studio_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-interior-design-studio-dashboard`
- **Family:** `interior-prayer`
- **Source image:** `mosque_interior_design_studio_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design/interior`
- **Prototype route:** `/prototypes/mosque-interior-design-studio-dashboard`
- **Status:** `visual_reference`

## Purpose
This frame is a visual rendition of the **interior-prayer** product family. It must be implemented from canonical domain data and shared components; values/text embedded in the generated image are illustrative unless independently source-backed.
...
## Related renditions
- `frame_mosque-interior-design-dashboard`
- `frame_mosque-interior-design-studio-mockup`

# Mosque Marketplace Comparison Dashboard

![Source frame](../../assets/mockups/mosque_marketplace_comparison_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-marketplace-comparison-dashboard`
- **Family:** `marketplace-procurement`
- **Source image:** `mosque_marketplace_comparison_dashboard.png`
- **Dimensions:** 1448 × 1086
- **Canonical product area:** `/projects/[projectId]/procurement`
- **Prototype route:** `/prototypes/mosque-marketplace-comparison-dashboard`

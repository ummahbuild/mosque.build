# Mosque Facilities Design Dashboard

![Source frame](../../assets/mockups/mosque_facilities_design_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-facilities-design-dashboard`
- **Family:** `design-studio`
- **Source image:** `mosque_facilities_design_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/mosque-facilities-design-dashboard`

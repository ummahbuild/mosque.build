# Mosque Design Studio Dashboard Mockup

![Source frame](../../assets/mockups/mosque_design_studio_dashboard_mockup.png)

## Frame identity
- **Frame ID:** `frame_mosque-design-studio-dashboard-mockup`
- **Family:** `design-studio`
- **Source image:** `mosque_design_studio_dashboard_mockup.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/mosque-design-studio-dashboard-mockup`
...
## Related renditions
- `frame_mosque-design-studio-dashboard`

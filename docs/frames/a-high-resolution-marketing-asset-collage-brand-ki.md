# High Resolution Marketing Asset Collage Brand Ki

![Source frame](../../assets/mockups/a_high_resolution_marketing_asset_collage_brand_ki.png)

## Frame identity
- **Frame ID:** `frame_a-high-resolution-marketing-asset-collage-brand-ki`
- **Family:** `marketing-brand`
- **Source image:** `a_high_resolution_marketing_asset_collage_brand_ki.png`
- **Dimensions:** 1536 × 1024
- **Canonical product area:** `/`
- **Prototype route:** `/prototypes/a-high-resolution-marketing-asset-collage-brand-ki`

# Construction Vendor Sourcing Dashboard

![Source frame](../../assets/mockups/construction_vendor_sourcing_dashboard.png)

## Frame identity
- **Frame ID:** `frame_construction-vendor-sourcing-dashboard`
- **Family:** `construction`
- **Source image:** `construction_vendor_sourcing_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/construction`
- **Prototype route:** `/prototypes/construction-vendor-sourcing-dashboard`

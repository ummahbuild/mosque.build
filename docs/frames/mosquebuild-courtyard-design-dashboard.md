# Mosque.build Courtyard Design Dashboard

![Source frame](../../assets/mockups/mosque.build_courtyard_design_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-courtyard-design-dashboard`
- **Family:** `site-landscape`
- **Source image:** `mosque.build_courtyard_design_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design/site`
- **Prototype route:** `/prototypes/mosquebuild-courtyard-design-dashboard`
- **Status:** `visual_reference`

## Purpose
This frame is a visual rendition of the **site-landscape** product family. It must be implemented from canonical domain data and shared components; values/text embedded in the generated image are illustrative unless independently source-backed.
...
## Related renditions
- `frame_mosque-courtyard-design-dashboard`

# Mosque Event Design Studio Dashboard

![Source frame](../../assets/mockups/mosque_event_design_studio_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-event-design-studio-dashboard`
- **Family:** `design-studio`
- **Source image:** `mosque_event_design_studio_dashboard.png`
- **Dimensions:** 1586 × 992
- **Canonical product area:** `/projects/[projectId]/design`
- **Prototype route:** `/prototypes/mosque-event-design-studio-dashboard`

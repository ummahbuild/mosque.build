# Mosque Interior Planning Dashboard

![Source frame](../../assets/mockups/mosque_interior_planning_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-interior-planning-dashboard`
- **Family:** `interior-prayer`
- **Source image:** `mosque_interior_planning_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design/interior`
- **Prototype route:** `/prototypes/mosque-interior-planning-dashboard`

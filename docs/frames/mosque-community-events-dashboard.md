# Mosque Community Events Dashboard

![Source frame](../../assets/mockups/mosque_community_events_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosque-community-events-dashboard`
- **Family:** `community`
- **Source image:** `mosque_community_events_dashboard.png`
- **Dimensions:** 1586 × 992
- **Canonical product area:** `/projects/[projectId]/community`
- **Prototype route:** `/prototypes/mosque-community-events-dashboard`

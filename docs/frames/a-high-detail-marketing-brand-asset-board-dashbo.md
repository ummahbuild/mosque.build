# High Detail Marketing Brand Asset Board Dashbo

![Source frame](../../assets/mockups/a_high_detail_marketing_brand_asset_board_dashbo.png)

## Frame identity
- **Frame ID:** `frame_a-high-detail-marketing-brand-asset-board-dashbo`
- **Family:** `marketing-brand`
- **Source image:** `a_high_detail_marketing_brand_asset_board_dashbo.png`
- **Dimensions:** 1536 × 1024
- **Canonical product area:** `/`
- **Prototype route:** `/prototypes/a-high-detail-marketing-brand-asset-board-dashbo`

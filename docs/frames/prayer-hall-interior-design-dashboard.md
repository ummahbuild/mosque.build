# Prayer Hall Interior Design Dashboard

![Source frame](../../assets/mockups/prayer_hall_interior_design_dashboard.png)

## Frame identity
- **Frame ID:** `frame_prayer-hall-interior-design-dashboard`
- **Family:** `interior-prayer`
- **Source image:** `prayer_hall_interior_design_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/design/interior`
- **Prototype route:** `/prototypes/prayer-hall-interior-design-dashboard`

# Mosque.build Empowering Communities Together

![Source frame](../../assets/mockups/mosque.build_empowering_communities_together.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-empowering-communities-together`
- **Family:** `marketing-brand`
- **Source image:** `mosque.build_empowering_communities_together.png`
- **Dimensions:** 935 × 1683
- **Canonical product area:** `/`
- **Prototype route:** `/prototypes/mosquebuild-empowering-communities-together`

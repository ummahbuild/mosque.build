# Mosque.build Community Review Dashboard

![Source frame](../../assets/mockups/mosque.build_community_review_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-community-review-dashboard`
- **Family:** `community`
- **Source image:** `mosque.build_community_review_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/community`
- **Prototype route:** `/prototypes/mosquebuild-community-review-dashboard`

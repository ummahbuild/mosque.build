# Construction Phasing Dashboard for Masjid Al Noor

![Source frame](../../assets/mockups/construction_phasing_dashboard_for_masjid_al_noor.png)

## Frame identity
- **Frame ID:** `frame_construction-phasing-dashboard-for-masjid-al-noor`
- **Family:** `construction`
- **Source image:** `construction_phasing_dashboard_for_masjid_al_noor.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/construction`
- **Prototype route:** `/prototypes/construction-phasing-dashboard-for-masjid-al-noor`
- **Status:** `visual_reference`

## Purpose
This frame is a visual rendition of the **construction** product family. It must be implemented from canonical domain data and shared components; values/text embedded in the generated image are illustrative unless independently source-backed.

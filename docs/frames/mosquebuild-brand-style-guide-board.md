# Mosque.build Brand Style Guide Board

![Source frame](../../assets/mockups/mosque.build_brand_style_guide_board.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-brand-style-guide-board`
- **Family:** `marketing-brand`
- **Source image:** `mosque.build_brand_style_guide_board.png`
- **Dimensions:** 1448 × 1086
- **Canonical product area:** `/`
- **Prototype route:** `/prototypes/mosquebuild-brand-style-guide-board`

# Mosque.build Jurisdiction Selector Dashboard

![Source frame](../../assets/mockups/mosque.build_jurisdiction_selector_dashboard.png)

## Frame identity
- **Frame ID:** `frame_mosquebuild-jurisdiction-selector-dashboard`
- **Family:** `permits-compliance`
- **Source image:** `mosque.build_jurisdiction_selector_dashboard.png`
- **Dimensions:** 1672 × 941
- **Canonical product area:** `/projects/[projectId]/permits`
- **Prototype route:** `/prototypes/mosquebuild-jurisdiction-selector-dashboard`
